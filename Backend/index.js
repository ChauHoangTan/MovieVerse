...
app.use((req, res, next) => {
  // 
  //Đổi thành res.setHeader('Access-Control-Allow-Origin', 'http://localhost:3000'); nếu dùng local
    res.setHeader('Access-Control-Allow-Origin', 'https://chauhoangtan.github.io');
